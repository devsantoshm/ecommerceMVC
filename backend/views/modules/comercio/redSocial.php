...
<div class="box box-success">
	...
	<div class="box-body">
		<div class="form-group">
			<label class="checkbox-inline"><input type="radio" name="colorRedSocial" value="color"> Color</label>
			<label class="checkbox-inline"><input type="radio" name="colorRedSocial" value="blanco"> Blanco</label>
			<label class="checkbox-inline"><input type="radio" name="colorRedSocial" value="negro"> Negro</label>
		</div>
		<?php  
