			...
			echo '<div class="container-fluid">
					<div class="container">
						<div class="jumbotron">
							...
							<p class="text-center">
								Tu artículo ha sido asignado a tus compras, pero antes queeremos presentarte las siguientes ofertas, si no deseas ver las ofertas y continuar en el artículo que acabas de adquirir haz click en el siguiente botón:
								<br><br>
								<a href="'.$urlFron.'perfil">
...
<div class="container-fluid">
	<div class="container">
		<div class="row" id="moduloOfertas">
			...
			$respuesta = ProductController::showCategories($item, $valor);
					...
					if ($value["finOferta"] > $fecha) {
						...
						echo '<div class="col-md-4 col-sm-6 col-xs-12">
							<div class="ofertas">
								...
								<figure>
									<img class="img-responsive" src="'.$urlBack.$value["imgOferta"].'" width="100%">
			...
			$respuestaSubcategorias = ProductController::showSubCategories($item, $valor);
			...
			$ordenar = "id";
			$respuestaProductos = ProductController::listProducts($ordenar, $item, $valor);
