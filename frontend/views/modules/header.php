	...
	<div class="container">
		<div class="row" id="cabezote">
			<div class="col-lg-3 col-md-3 col-sm-2 col-xs-12" id="logotipo">
				<a href="#">
					<img src="http://localhost/ecommerce/backend/views/img/plantilla/logo.png" class="img-responsive">
				</a>
			</div>
