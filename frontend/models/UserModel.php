...
class UserModel
{
	...
	{
		$stmt = Conexion::conectar()->prepare("INSERT INTO $table(nombre, password, email, modo, verificacion, emailEncriptado) VALUES(:nombre, :password, :email, :modo, :verificacion, :emailEncriptado)");
